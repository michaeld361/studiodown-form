...
import STEPS from "./YellowTailSteps";
...
// ── CACHE HELPERS ──
const CACHE_KEY = "studiodown_yellowtail";
...
// ── BLOB ──
// Yellow-Tail palette: muted greens, denim blues, with a yellow core
function LivingBlob({ dimmed }) {
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      // Yellow-Tail tones: sage green, denim blue, muted teal, warm yellow
      const layers = [
        { scale: 1.15, opacity: 0.04, speed: 0.5, hue: 140, sat: 14 },  // sage green
        { scale: 1.0,  opacity: 0.06, speed: 1,   hue: 210, sat: 18 },  // denim blue
        { scale: 0.85, opacity: 0.05, speed: 1.3, hue: 170, sat: 12 },  // muted teal
        { scale: 0.65, opacity: 0.05, speed: 0.7, hue: 48,  sat: 40 },  // warm yellow
      ];
...
// ── MAIN APP ──
export default function YellowTailApp() {
          ...
          <div style={{
            ...
            <div style={{ maxWidth: 520 }}>
              ...
              <p style={{
                ...
                letterSpacing: "0.01em", maxWidth: 440,
              ...
              }}>A few questions to understand your film, the event, and the feeling you want the site to carry.</p>
      ...
      {view === "done" && (
        <div style={{
          ...
          <div style={{ maxWidth: 480 }}>
            <h1 style={{ fontSize: 42, fontWeight: 300, lineHeight: 1.2, marginBottom: 16, letterSpacing: "-0.02em" }}>That's a wrap.</h1>
            <p style={{ fontSize: 15, color: "#888", lineHeight: 1.7, letterSpacing: "0.01em", whiteSpace: "pre-line" }}>
              {"This gives us everything we need to start building your premiere site.\n\nWe'll be in touch shortly."}
            </p>
          </div>
          <div style={{
